...
- Use the cheap plugin to process modules that call the libmedia interfaces. For detailed usage, refer to the build configuration [example](https://github.com/zhaohappy/libmedia-example).
