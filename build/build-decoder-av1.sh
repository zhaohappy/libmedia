...
EMCCFLAG=""
DIR_SUBFIX=""
LIBDAV1D=$PROJECT_ROOT_PATH/lib/dav1d/lib/libdav1d.a
...
if [[ $ENABLE_SIMD == "1" ]]; then
  ...
  LIBDAV1D=$PROJECT_ROOT_PATH/lib/dav1d-simd/lib/libdav1d.a
else 
  if [ $ENABLE_ATOMIC == "1" ]; then
    DIR_SUBFIX="$DIR_SUBFIX-atomic"
    FFMPEG_AVUTIL_PATH=$PROJECT_ROOT_PATH/lib/ffmpeg-atomic/lib
    LIBDAV1D=$PROJECT_ROOT_PATH/lib/dav1d-atomic/lib/libdav1d.a
