...
PROJECT_SRC_PATH=$PROJECT_ROOT_PATH/packages
...
CLIB_PATH=$PROJECT_SRC_PATH/audioresample/src/clib
...
if [ $ENABLE_WASM64 == "1" ]; then
  ...
  FFMPEG_RESAMPLE_PATH=$PROJECT_ROOT_PATH/lib/ffmpeg-64/lib
else
  if [[ $ENABLE_SIMD == "1" ]]; then
