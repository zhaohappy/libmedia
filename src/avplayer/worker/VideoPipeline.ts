...
import { VideoDecodePipeline, VideoRenderPipeline } from '@libmedia/avpipeline'
...
export default class VideoPipeline {
  ...
  private decoder: VideoDecodePipeline

  private render: VideoRenderPipeline
  ...
  constructor() {
    this.decoder = new VideoDecodePipeline()
    this.render = new VideoRenderPipeline()
