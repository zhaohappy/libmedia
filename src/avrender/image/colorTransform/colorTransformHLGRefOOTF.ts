...
const kGammaMinusOne = 0.2

export default function colorTransformHLGRefOOTF(options: ColorTransformOptions) {
    ...
    return `
      {
        ...
        if (L > 0.0) {
          color.r *= pow(L, ${kGammaMinusOne});
          color.g *= pow(L, ${kGammaMinusOne});
          color.b *= pow(L, ${kGammaMinusOne});
        }
      }
    `
  }
